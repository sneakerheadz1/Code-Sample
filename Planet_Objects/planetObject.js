...
//   console.log(solarSystem[7].moons[1])
  ...
  solarSystem[2].moons.push("Endor")
  ...
  solarSystem.push("name") 
  solarSystem.name = "Pluto"
  solarSystem[8].name = "ringSystem"
...
//  solarSystem.earth.diameter.push("7,917.5 mi") 
//  console.log(solarSystem[2])
  ...
  solarSystem.map( (objectInTheArray)=>{
      if(objectInTheArray.ringSystem == true){
      console.log(objectInTheArray)
      }
    })
...
let satSum = parseInt(system.jupiter.satellites) +  system.saturn.satellites + system.uranus.satellites + system.neptune.satellites
// console.log(satSum)

// 4. Write a conditional that checks if Mercury's radiusp is a string (remember the typeof command). If Mercury's radiusp is a string, 
// change the value to be the same as its radiuse value. (radiusp is radius at the poles, radiuse is radius at the equator).
let merType = typeof(system.mercury.radiusp)
// console.log(merType)
...
system.mercury.radiusp = merType
...
// console.log(jupMom)
let pluMom = system.pluto.mass + system.pluto.velocity
let momentumDif = jupMom - pluMom
// console.log("This is the difference between their momentum  " + momentumDif)
...
/*-----------------------------hw due saturday--------------------------------------*/
// example
let sumOfArray = (arrayToFindSum) =>{
   let sum = arrayTofindSum[0] + arrayToFindSum[1]
//    console.log(sum)
